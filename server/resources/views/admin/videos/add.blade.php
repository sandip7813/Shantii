...
@section('content')
    ...
    <div class="module">
        ...
        <div class="module-body">
                ...
                <form method="POST" action="{{ route('admin.videos.store') }}" class="form-horizontal row-fluid">
                    @csrf
                    
                    <div class="control-group">
                        <label class="control-label" for="video_title">Video Title</label>
                        <div class="controls">
                            <input type="text" name="video_title" id="video_title" placeholder="Video Title" class="span8" value="{{ old('video_title') }}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="video_link" id="video_link" placeholder="YouTube Link" class="span8" value="{{ old('video_link') }}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="span8" name="video_description" id="video_description" rows="5" placeholder="Video Description">{{ old('video_description') }}</textarea>
