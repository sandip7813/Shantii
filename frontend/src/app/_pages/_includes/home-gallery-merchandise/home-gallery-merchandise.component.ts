...
@Component({
  selector: 'app-home-gallery-merchandise',
  templateUrl: './home-gallery-merchandise.component.html'
})
export class HomeGalleryMerchandiseComponent implements OnInit {
  ...
  ngOnInit(): void {
    //++++++++++++++++++++++++ FETCH PHOTOS :: Start ++++++++++++++++++++++++//
    this.observer = this.photoService.get_gallery_photos('merchandise');
